...
export const VendorsCard = ({ data }: { data?: any }) => {
    ...
    return (
        <Card
            ...
            onClick={() => navigate("/dashboard/detail/vendors")}
        >
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-[13px] font-bold text-gray-700 uppercase tracking-tight">VENDORS</CardTitle>
            </CardHeader>
            <CardContent className="space-y-8 pt-2">
                ...
                <div className="space-y-3">
                    ...
                    <div className="h-5 w-full flex bg-gray-200 rounded-sm overflow-hidden mt-2">
                        <div
                            className="h-full bg-[#0077c5] transition-all duration-500"
                ...
                <div className="space-y-3">
                    ...
                    <div className="flex justify-between items-end">
                        <div className="space-y-0.5">
                            <div className="text-2xl font-bold text-gray-900">${paidTotal.toLocaleString()}</div>
                            <div className="text-[11px] text-gray-500 font-medium uppercase tracking-wider">Amount Paid</div>
                        </div>
                    </div>

                    <div className="h-5 w-full flex bg-[#00a1b1] rounded-sm overflow-hidden mt-2">
                        <div
